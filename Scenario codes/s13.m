...
% Generated on: 26-Apr-2024 00:16:08
...
sensors{1} = visionDetectionGenerator('SensorIndex', 1, ...
    'SensorLocation', [1.33 0.01], ...
    'Yaw', -8.59591143692097, ...
    'DetectorOutput', 'Objects only', ...
    'ActorProfiles', profiles);
sensors{2} = drivingRadarDataGenerator('SensorIndex', 2, ...
    'MountingLocation', [0.96 0.19 0.2], ...
    'MountingAngles', [8.74616226255521 0 0], ...
...
egoVehicle = vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [41.4088210170972 2.54320408574493 0], ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'Car');
waypoints = [41.4088210170972 2.54320408574493 0;
    35.4 0.6 0;
    26.7 0.4 0;
    20.8 1 0];
speed = [20;25;30;30];
...
car1 = vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [33.7134488713127 4.68684374882478 0], ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'Car1');
waypoints = [33.7134488713127 4.68684374882478 0;
    18.8 3.9 0;
    11.6 0.8 0;
    9 -0.3 0];
speed = [20;30;20;20];
